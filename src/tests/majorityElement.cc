...
int findMin(int a[], int b[], int num)
{
	int diff;
	int min = 2^31;
...
void getSumMatch(int a[], int b[], int sum, int num)
{
	map<int,int> M;
	for (int i = 0; i < num; i++) {
		for (int j = 0; j < num; j++) {
...
main(int argc, char **argv)
{
	...
	int a[] = {1,3,15,11,2};
	int b[] = {23,137,5,19,8};
	cout << "Min =" << findMin(a,b,num) << endl;
	cout << "sum =" << mySum(89898,77667) << endl;

	getSumMatch(a,b, num, 20);

	int c[] = {5,-9,6,-2,3};
	cout << "Max =" << getMaxSum(a, num) << endl;
